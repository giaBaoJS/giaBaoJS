...
**101 pull requests to 47 external open-source projects.** Every fix starts with a root-cause investigation and a regression test that fails without the patch.

![merged](https://img.shields.io/badge/merged-22-2EA44F?style=flat-square)
